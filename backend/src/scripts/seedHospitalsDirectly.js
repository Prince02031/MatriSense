...
const demoHospitals = [
  ...
  },
  {
    ...
    division: 'Dhaka',
    district: 'Gazipur',
    upazilaOrThana: 'Gazipur Sadar',
    address: 'Gazipur Sadar, Gazipur',
    latitude: 23.9984,
    longitude: 90.4253,
    phone: '02-9262174',
    services: ['Antenatal Care', 'Postnatal Care', 'Normal Delivery', 'C-Section', 'NICU', 'ICU', 'Emergency Obstetric Care', 'Blood Transfusion'],
    specialties: ['high_risk_pregnancy', 'severe_preeclampsia', 'neonatal_resuscitation', 'blood_transfusion'],
    description: 'Primary government tertiary teaching hospital in Gazipur. Provides 24/7 emergency obstetric care, maternal surgeries, blood transfusion support, and intensive neonatal care.',
    isActive: true
  },
  {
    name: 'Shaheed Ahsan Ullah Master General Hospital (Tongi)',
    type: 'district_hospital',
    division: 'Dhaka',
    district: 'Gazipur',
    upazilaOrThana: 'Tongi',
    address: 'Tongi, Gazipur',
    latitude: 23.8903,
    longitude: 90.4025,
    phone: '01711223388',
    services: ['Antenatal Care', 'Postnatal Care', 'Normal Delivery', 'C-Section', 'Emergency Obstetric Care'],
    specialties: ['normal_delivery', 'mild_preeclampsia', 'blood_transfusion'],
    description: '250-bed government hospital serving the industrial hub of Tongi. Offers 24/7 emergency services, maternity wards, prenatal checkups, and general surgical deliveries.',
    isActive: true
  },
  {
    ...
    district: 'Gazipur',
    upazilaOrThana: 'Tongi',
    address: 'Garia, Tongi, Gazipur',
    latitude: 23.9168,
    longitude: 90.3802,
    phone: '02-9815403',
    services: ['Antenatal Care', 'Postnatal Care', 'Normal Delivery', 'C-Section', 'NICU', 'ICU', 'Emergency Obstetric Care'],
    specialties: ['high_risk_pregnancy', 'nicu_neonatology', 'eclampsia_management'],
    description: 'Private medical college and hospital situated in Tongi. Equipped with an advanced NICU, comprehensive maternal diagnostic services, private delivery units, and high-risk pregnancy management.',
    isActive: true
  },
  {
    name: 'Narayanganj 300-Bed Hospital (Khanpur)',
    type: 'district_hospital',
    division: 'Dhaka',
    district: 'Narayanganj',
    upazilaOrThana: 'Narayanganj Sadar',
    address: 'Khanpur, Narayanganj Sadar, Narayanganj',
    latitude: 23.6189,
    longitude: 90.4998,
    phone: '02-7645163',
    services: ['Antenatal Care', 'Postnatal Care', 'Normal Delivery', 'C-Section', 'NICU', 'Emergency Obstetric Care', 'Blood Transfusion'],
    specialties: ['high_risk_pregnancy', 'normal_delivery', 'blood_transfusion'],
    description: 'Major government district hospital in Narayanganj (Khanpur). Serves as a vital referral hub for maternal complications, offering 24/7 delivery services, neonatal stabilization, and surgical obstetric interventions.',
    isActive: true
  },
  {
    name: 'Narayanganj General (Victoria) Hospital',
    type: 'district_hospital',
    division: 'Dhaka',
    district: 'Narayanganj',
    upazilaOrThana: 'Narayanganj Sadar',
    address: 'Bangabandhu Road, Narayanganj Sadar, Narayanganj',
    latitude: 23.6235,
    longitude: 90.5012,
    phone: '02-7633215',
    services: ['Antenatal Care', 'Postnatal Care', 'Normal Delivery', 'Basic Emergency Obstetric Care'],
    specialties: ['normal_delivery', 'mild_preeclampsia', 'antenatal_screening'],
    description: 'Historic government general hospital in Narayanganj city center. Highly trusted for affordable normal deliveries, routine antenatal screening, maternal health guidance, and vaccine distributions.',
    isActive: true
  },
  {
    name: 'Sajida Foundation Hospital (Narayanganj)',
    type: 'private_clinic',
    division: 'Dhaka',
    district: 'Narayanganj',
    upazilaOrThana: 'Narayanganj Sadar',
    ...
    phone: '01730030111',
    services: ['Antenatal Care', 'Postnatal Care', 'Normal Delivery', 'C-Section', 'Emergency Obstetric Care'],
    specialties: ['normal_delivery', 'mild_preeclampsia', 'postpartum_hemorrhage'],
    description: 'Non-profit private hospital run by SAJIDA Foundation. Specializes in affordable, high-quality maternal and child healthcare, normal delivery promotion, and emergency C-section facilities.',
    isActive: true
  }
];
...
const seedHospitals = async () => {
  ...
  try {
    ...
    console.log(`Connected successfully. Cleaning collection...`);

    const deleted = await Hospital.deleteMany({});
    console.log(`Deleted ${deleted.deletedCount} existing hospitals.`);

    console.log(`Inserting ${demoHospitals.length} new Dhaka-focused seed hospitals...`);
    const inserted = await Hospital.insertMany(demoHospitals);
